...
public class HelloWorldTypeSupport extends TypeSupportImpl {
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment +=  CdrPrimitiveType.getStringMaxSizeSerialized(currentAlignment, (((HELLODDS_MAX_STRING_SIZE.VALUE))) + 1);
            
        currentAlignment +=  CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment);
            
        currentAlignment +=  CdrPrimitiveType.BYTE.getSequenceMaxSizeSerialized(currentAlignment, ((HELLODDS_MAX_PAYLOAD_SIZE.VALUE)));
	...
	Object sample) 
    {
        ...
        currentAlignment += CdrPrimitiveType.getStringSerializedSize(currentAlignment, typedSrc.prefix);
            
        currentAlignment += CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment);
            
        currentAlignment += CdrPrimitiveType.BYTE.getSequenceSerializedSize(currentAlignment, typedSrc.payload);
...
HelloWorld typedSrc = (HelloWorld) src;    
        ...
        dst.writeString(typedSrc.prefix,((HELLODDS_MAX_STRING_SIZE.VALUE)));
            
        dst.writeInt(typedSrc.sampleId);        
            
        dst.writeByteSeq(typedSrc.payload,((HELLODDS_MAX_PAYLOAD_SIZE.VALUE)));
...
HelloWorld typedDst = (HelloWorld) dst;
    ...
    try {
            ...
            typedDst.prefix = src.readString(((HELLODDS_MAX_STRING_SIZE.VALUE)));
            
            typedDst.sampleId = src.readInt();
            
            src.readByteSequence(typedDst.payload);
